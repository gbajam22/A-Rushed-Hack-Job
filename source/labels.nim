...
func x*(self: Label): int {.inline.} =
  self.obj.x

func `x=`*(self: var Label, x: int) {.inline.} =
  self.obj.x = x

func y*(self: Label): int {.inline.} =
  self.obj.y

func `y=`*(self: var Label, y: int) {.inline.} =
  self.obj.y = y

func pal*(self: Label): int {.inline.} =
  self.obj.pal

func `pal=`*(self: var Label, pal: int) {.inline.} =
  self.obj.pal = pal
